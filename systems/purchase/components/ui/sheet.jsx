    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          ...
          side === "right" &&
            "data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right top-3 right-3 bottom-3 h-[calc(100%-1.5rem)] w-[calc(100%-1.5rem)] sm:max-w-sm",
          side === "left" &&
            "data-[state=closed]:slide-out-to-left data-[state=open]:slide-in-from-left top-3 left-3 bottom-3 h-[calc(100%-1.5rem)] w-[calc(100%-1.5rem)] sm:max-w-sm",
          side === "top" &&
