...
// Supabase is used by the Order system for ONE thing only: file/image
// uploads via Supabase Storage. Every other connection — data queries
// (.from()/.rpc()) and realtime (.channel()) — is intentionally stubbed out
// so the frontend never talks to Supabase for data; that all goes through
// the backend API (NEXT_PUBLIC_API_URL). Mirrors systems/purchase/supabase.js.
